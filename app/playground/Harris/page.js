  ...
  return (
    <div className="flex justify-center">
      ...
      <div className="flex flex-col ml-4 mt-3">
        ...
        {/* Journal Overlay */}
        {showJournal && (
          <div className=" absolute top-[-320] mt-100 bg-[#0A0A0A] bg-opacity-50 flex items-center justify-center z-50 ">
            <div className="w-full max-w-2xl bg-black rounded-lg shadow-xl border border-gray-200 p-4">
              <div className="flex justify-between items-center mb-4">
                <h3 className="font-bold text-xl">Food Journal</h3>
                <button
