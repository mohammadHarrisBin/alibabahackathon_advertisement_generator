...
export default function NutritionCard({ analysis, setJournalData }) {
  ...
  return (
    <div className="w-[500px] relative mt-4 bg-black not-dark:bg-white  rounded-lg border shadow-sm">
      {/* Card Header */}
      ...
      <div className="p-4">
        ...
        {activeTab === 'nutrition' && (
          <div className="space-y-4 pt-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 not-dark:text-white">
            ...
            <div className="mt-4">
              ...
              <div className="flex flex-wrap gap-2">
                {analysis.ingredients.map((ingredient, i) => (
                  <span key={i} className="not-dark:text-white px-2 py-1 text-sm bg-emerald-600 border border-gray-200 rounded-md">
                    {ingredient}
                  </span>
                ))}
              </div>
        ...
        {/* Risks Tab */}
        {activeTab === 'risks' && (
          <div className="pt-4 space-y-4 not-dark:text-black">
            {analysis.sicknesses.map((sickness, i) => (
              <div key={i} className="border rounded-lg p-4">
                ...
                <p className="text-sm text-white not-dark:text-black">
