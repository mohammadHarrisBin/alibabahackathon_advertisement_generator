  ...
  return (
    <div className="mt-4 w-full max-w-2xl">
      <form onSubmit={handleSubmit} className="relative">
        ...
        <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden bg-black not-dark:bg-white">
          ...
          <div className="flex">
            ...
            <button
              ...
              className="bg-emerald-600 text-white px-4 py-3 m-1 disabled:opacity-50"
            >
              <Send size={18} />
            </button>
          </div>
        ...
        {/* Adjustment Panel */}
        {showAdjustments && (
          <div className="absolute bottom-full mb-2 left-0 right-0 border border-gray-200 rounded-lg shadow-lg p-4 z-10 bg-black not-dark:bg-white">
